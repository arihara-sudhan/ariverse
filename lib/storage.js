...
function canonicalizeStoragePath(pathname) {
  ...
  if (clean.startsWith(publicPrefix)) {
    clean = clean.slice(publicPrefix.length);
  }
  ...
  if (clean === 'arizone/posts/untitled') {
    return 'arichuvadi/posts/oyvu-naal';
  }
  if (clean.startsWith('arizone/posts/untitled/')) {
    clean = clean.replace(/^arizone\/posts\/untitled\//, 'arichuvadi/posts/oyvu-naal/');
  }
  if (clean === 'arizone/posts/oyvu-naal') {
    return 'arichuvadi/posts/oyvu-naal';
  }
  if (clean.startsWith('arizone/posts/oyvu-naal/')) {
    clean = clean.replace(/^arizone\/posts\/oyvu-naal\//, 'arichuvadi/posts/oyvu-naal/');
  }
...
export const HOME_HERO_IMAGE_URL = '/static/ariverse-hero.webp';
